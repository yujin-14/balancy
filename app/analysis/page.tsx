...
export default function AnalysisPage() {
  // モックデータ：今週の曜日ごとのバランス（WORK比率）
  const WEEK_DATA = [
    { day: "Mon", workH: 80, color: "bg-blue-400" },
    { day: "Tue", workH: 95, color: "bg-blue-500" },
    { day: "Wed", workH: 50, color: "bg-orange-500" }, // ジャスト調和！
    { day: "Thu", workH: 75, color: "bg-blue-400" },
    { day: "Fri", workH: 40, color: "bg-orange-400" }, // ご自愛多め！
